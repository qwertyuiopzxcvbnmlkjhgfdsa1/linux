...
static int s5k2xx_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_EXPOSURE:
		ret = s5k2xx_write_reg(s5k2xx, S5K2XX_REG_EXPOSURE,
				S5K2XX_REG_VALUE_16BIT, ctrl->val);
		break;
	case V4L2_CID_ANALOGUE_GAIN:
		ret = s5k2xx_write_reg(s5k2xx, S5K2XX_REG_ANALOG_GAIN,
				S5K2XX_REG_VALUE_16BIT, ctrl->val);
		break;
	case V4L2_CID_DIGITAL_GAIN:
		ret = s5k2xx_write_reg(s5k2xx, S5K2XX_REG_DIG_GAIN,
				S5K2XX_REG_VALUE_16BIT, ctrl->val);
		break;
	case V4L2_CID_VBLANK:
		ret = s5k2xx_write_reg(s5k2xx, S5K2XX_REG_FLL,
				      S5K2XX_REG_VALUE_16BIT,
...
static int s5k2xx_identify_module(struct s5k2xx *s5k2xx)
{
	...
	ret = s5k2xx_read_reg(s5k2xx, S5K2XX_REG_ANALOG_GAIN_MIN,
			     S5K2XX_REG_VALUE_16BIT, &val);
	if (ret)
		return ret;
	...
	ret = s5k2xx_read_reg(s5k2xx, S5K2XX_REG_ANALOG_GAIN_MAX,
			     S5K2XX_REG_VALUE_16BIT, &val);
	if (ret)
		return ret;
